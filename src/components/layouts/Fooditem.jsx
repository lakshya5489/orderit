            ...
            <div className="col-sm-12 col-md-6 col-lg-3 my-3">
                <div className="card p-3 rounded">
                    ...
                    <div className="card-body d-flex flex-column">
                        ...
                        <p className="card-text"><FaRupeeSign />{fooditem.price}
                        <br/>

                        </p>
                         {!showButtons ? (<button type='button' id='cart_btn' className='btn btn-primary d-inline ml-4 ' disabled={fooditem.stock===0} onClick={addToCartHandler}>Add To Cart</button>):
                         (
                            <div className="stockCounter d-inline">
                                <span className="btn btn-danger minus" onClick={decreaseQty}>-</span>
                                <input type="number" value={quantity} readOnly className="form-control count d-inline" />
                                <span className="btn btn-primary plus" onClick={increaseQty}>+</span>
                            </div>
                         )}

                        <br/>
                        <p>Status:<span id="stock_status" className={fooditem.stock ? "greenColor": "redColor"}>{fooditem.stock?"In Stock":"Out Of Stock"}</span>
